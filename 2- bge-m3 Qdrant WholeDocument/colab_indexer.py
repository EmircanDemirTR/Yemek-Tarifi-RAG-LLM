# -*- coding: utf-8 -*-
"""
🍳 RAG Tarif Arama Sistemi - Colab Indexer
==========================================
...
DATA_FILE = "/content/drive/MyDrive/Dersler - Projeler/Derin Öğrenme Dersi/2- bge-m3 Qdrant WholeDocument/temiz.jsonl"
...
print("=" * 60)
print("🍳 RAG TARİF ARAMA SİSTEMİ - COLAB INDEXER")
print("=" * 60)
...
with tqdm(total=total_recipes, desc="İndexleniyor", unit="tarif") as pbar:
    for batch in batch_iterator(recipes_generator, BATCH_SIZE):
        # Metinleri oluştur
        texts = [create_recipe_text(r) for r in batch]
...
---------------------------------------------------------
import shutil
DRIVE_PATH = "/content/drive/MyDrive/Dersler - Projeler/Derin Öğrenme Dersi/2- bge-m3 Qdrant WholeDocument/qdrant_data.zip"
...
3. Yerel bilgisayarınızda çalıştırın:
   ...
   cd "E:\\Drive'ım\\Dersler - Projeler\\Derin Öğrenme Dersi\\2- bge-m3 Qdrant WholeDocument"
